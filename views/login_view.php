                            ...
                            <div class="card-front">
                                <div class="center-wrap">
                                    <div class="section text-center">
                                        ...
                                        <p class=" login mb-0 mt-4 text-center"><a href="#0" class="link">Forgot your password?</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-back">
                                <div class="center-wrap">
                                    <div class="section text-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="profile-picture" class="hidden" id="profile-picture" accept="image/*">
